...
public class MapObjectZOO extends MapObject {
    ...
    public MapObjectZOO(int X, int Y, MapActivity activity) {
        super(X, Y, activity);
        objectX = X;
        objectY = Y;
        type = "ZOO";
        ...
        task2.targetCell = activity.map.mMapCells[X][Y]; //Во втором задании сразу известна ячейка: нужо вернуть кота назад сюда

        cat = activity.findViewById(R.id.cat);
            ...
            mapActivity.runOnUiThread(new Runnable() {
                ...
                public void run() {
                    ...
                    for (int x = currentCell.x + 1; x < mapActivity.map.mLength; x++) {
                        ...
                        if (toRight == 0) {
                            toRight = 1; //как минимум в тупик, но дорога куда-то едет
                        }
                    ...
                    for (int x = currentCell.x - 1; x >= 0; x--) {
                        ...
                        if (toLeft == 0) {
                            toLeft = 1; //как минимум в тупик, но дорога куда-то едет
                        }
                        if (currentCell.y < (mapActivity.map.mHeight - 1)) {
                            if (mapActivity.map.mMapCells[x][currentCell.y + 1].type.equals("Road")) {
                    ...
                    for (int y = currentCell.y + 1; y < mapActivity.map.mHeight; y++) {
                        ...
                        if (toDown == 0) {
                            toDown = 1; //как минимум в тупик, но дорога куда-то едет
                        }
                    ...
                    for (int y = currentCell.y - 1; y >= 0; y--) {
                        ...
                        if (toUp == 0) {
                            toUp = 1; //как минимум в тупик, но дорога куда-то едет
                        }
                        if (currentCell.x < (mapActivity.map.mLength - 1)) {
                            if (mapActivity.map.mMapCells[currentCell.x + 1][y].type.equals("Road")) {
                    ...
                    if (danger == 0) {
                        ...
                        if (trend > 0) {
                            ...
                            else if (newTrend == 1 && toLeft == 0)
                                newTrend = 0; //нужно менять направление
                            else if (newTrend == 2 && toUp == 0)
                                newTrend = 0; //нужно менять направление
                            else if (newTrend == 3 && toRight == 0)
                                newTrend = 0; //нужно менять направление
                            else if (newTrend == 4 && toDown == 0)
                                newTrend = 0; //нужно менять направление
                        }
                    } else {
                        if (params.leftMargin > (startX + 10) || params.leftMargin < (startX - 10) || params.topMargin < (startY - 10) || params.topMargin > (startY + 10)) {
                    ...
                    if (newTrend == 0) {
                        ...
                        if (danger == 1 || danger == 3) {
                            ...
                            else if (danger == 1 && toRight > 1)
                                newTrend = 3; //лучше в противоположном направлении, чем в тупик
                            else if (danger == 3 && toLeft > 1)
                                newTrend = 1; //лучше в противоположном направлении, чем в тупик
                            else if (toUp > 0) newTrend = 2;
                            else if (toDown > 0) newTrend = 4;
                            else if (danger == 1 && toRight > 0)
                                newTrend = 3; //лучше в противоположном направлении, чем под машину
                            else if (danger == 3 && toLeft > 0)
                                newTrend = 1; //лучше в противоположном направлении, чем под машину
                            ...
                            else if (danger == 2 && toDown > 1)
                                newTrend = 4; //лучше в противоположном направлении, чем в тупик
                            else if (danger == 4 && toUp > 1)
                                newTrend = 2; //лучше в противоположном направлении, чем в тупик
                            else if (toLeft > 0) newTrend = 1;
                            else if (toRight > 0) newTrend = 3;
                            else if (danger == 2 && toDown > 0)
                                newTrend = 4; //лучше в противоположном направлении, чем под машину
                            else if (danger == 4 && toUp > 0)
                                newTrend = 2; //лучше в противоположном направлении, чем под машину
                        } else {
                    ...
                    cat.setLayoutParams(params);
                    if (task == mapActivity.getTask(carCell)) {
                        task.finishTask();
                    }
