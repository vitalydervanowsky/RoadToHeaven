...
import com.carloclub.roadtoheaven.Lesson;
...
public class Sokolka {
    ...
    public static void loadTextsBY(MyMap Map) {
        ...
        Map.addWordsForRM(6, "ДРУЖА","Анёле Божы,","мой, Ты заўсёды будзь са мной.\nРана, увечар і ўначы Будзь ласкаў мне памагчы\nЗмагаць духа злога, Верна служыць Богу.\nДушу, цела сцеражы, Да жыцця вечнага давядзі. Амэн.");
        Map.addWordsForRM(7, "ЗМАГАЦЬ","Анёле Божы, дружа мой, Ты заўсёды будзь са мной.\nРана, увечар і ўначы Будзь ласкаў мне памагчы","духа злога, Верна служыць Богу.\nДушу, цела сцеражы, Да жыцця вечнага давядзі. Амэн.");
        Map.myLessons = new ArrayList<Lesson>();
        String dataLesson;
        dataLesson = "1. Накарміць галодных.\n2. Напаіць сасмаглых.\n3. Адзець нагіх.\n4. Прыняць у дом падарожных.\n5. Адведваць хворых.\n6. Суцяшаць вязняў.\n7. Пахаваць памерлых.";
        Map.myLessons.add(new Lesson(R.drawable.galery1_1,dataLesson,"Учынкі міласэрнасці для цела бліжняга", R.raw.rrr));
        dataLesson = "Вучынак міласэрнасці — гэта праява любові і спагады да іншага чалавека. Першы з іх — накарміць галоднага — з’яўляецца самым простым, але адначасова самым глыбокім дзеяннем, якое сведчыць пра нашу чалавечнасць.\nКалі мы кормім галоднага, мы не толькі даем яму ежу, але і прызнаем яго годнасць, падзяляем яго боль, прымаем яго патрэбу як сваю. \nУ свеце, дзе многія пакутуюць ад недахопу, гэты ўчынак вучыць нас бачыць у кожным чалавеку брата, а ў яго голадзе — магчымасць для любові.";
        Map.myLessons.add(new Lesson(R.drawable.galery1_1,dataLesson,"Накарміць галоднага", R.raw.complete));
        dataLesson = "Гэта просты, але вельмі добры ўчынак. Ён вучыць нас быць уважлівымі, дбайнымі і спагадлівымі. Есус казаў, што калі мы дапамагаем іншым — мы дапамагаем Яму.\nНават шклянка вады можа стаць знакам любові. Таму, калі ты бачыш, што хтосьці прагне — падай яму вады. Гэта будзе тваім учынкам міласэрнасці.";
        Map.myLessons.add(new Lesson(R.drawable.galery1_2,dataLesson,"Напаіць прагнучага", R.raw.complete));
        dataLesson = "Калі чалавек не мае адзення, яму холадна, няёмка і сумна. Ён адчувае сябе пакінутым. Калі мы даём яму вопратку, мы паказваем, што ён нам важны, што мы хочам, каб яму было цёпла і камфортна. Бог радуецца, калі мы дзелімся тым, што маем. А чалавек, якому мы дапамаглі, адчувае цеплыню не толькі ад вопраткі, але і ад нашай любові.";
        Map.myLessons.add(new Lesson(R.drawable.galery1_3,dataLesson,"Адзець голага", R.raw.complete));
        dataLesson = "Калі чалавек хварэе, яму цяжка, сумна і самотна. Ён часта ляжыць у ложку і не можа гуляць, як усе. Калі мы прыходзім да яго, прыносім усмешку, добрыя словы або малюнак — мы робім яго дзень лепшым.\nАдведаць хворага — гэта значыць паказаць, што ён не адзін, што мы пра яго памятаем і любім. Гэта вельмі важны ўчынак, бо ён лечыць не толькі цела, але і душу.";
        Map.myLessons.add(new Lesson(R.drawable.galery1_6,dataLesson,"Адведаць хворага", R.raw.complete));
