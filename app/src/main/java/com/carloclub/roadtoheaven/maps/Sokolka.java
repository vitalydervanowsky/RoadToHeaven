...
public class Sokolka {
    ...
    public static void loadTextsBY(MyMap Map) {
        ...
        Map.addMission(0);
        Map.Missions[0].messageText="Вітаю цябе ў горадзе Сакулка! Тут мы пазнаёмімся з цудоўнымі “учынкаміміласэрнасці”.\nЖыхары гораду маюць камяні ведаў. Яны аддадуць іх за выкананне заданняў.\nЗ гэтых камянёў ты пабудуеш мост і зможаш працягнуць падарожжа. Вырушаем!";
        Map.Missions[0].messageIconMap="AZS";
        Map.Missions[0].messageIconSource="icon_fuel";
        Map.Missions[0].missionType="count_fuel";
        Map.Missions[0].targetValue1=1;
        Map.addMission(1);
        Map.Missions[1].messageText="Пачнем наша падарожжа. Едзь на запраўку и здабудзь поўны бак бензіна.";
        Map.Missions[1].messageIconMap="AZS";
        Map.Missions[1].messageIconSource="icon_fuel";
        Map.Missions[1].missionType="count_fuel";
        Map.Missions[1].targetValue1=16000;
        Map.addMission(2);
        Map.Missions[2].messageText="Выдатна! Цяпер накіроўвайся ў школу, каб здабыць неабходныя веды.";
        Map.Missions[2].messageIconMap="";
        Map.Missions[2].messageIconSource="icon_ruby";
        Map.Missions[2].missionType="object_school";
        Map.Missions[2].targetValue1=0;
        Map.addMission(3);
        Map.Missions[3].messageText="Выдатна! Цяпер знайдзі чалавека, якому патрэбна дапамога. Шукай на мапе такі рубін.";
        Map.Missions[3].messageIconMap="";
        Map.Missions[3].messageIconSource="icon_ruby";
        Map.Missions[3].missionType="count_ruby";
        ...
        Map.Missions[4].messageIconSource="blue_stone";
