...
public class Messages {
    ...
    public static String getMessageFromPilgrim() {
        if (Constants.isBy()) {
            return "Вітанкі! Я пілігрым. Шукаю касцёл. Калі ты мяне падвязеш, я буду табе вельмі ўдзячы.";
        }
        if (Constants.isRu()) {
            return "Привет! Я пилигрим. Ищу костел. Если ты меня подвезешь, я буду тебе очень благодарен.";
        }
        return "";
    }
